...
Also by default, Blackhole Pro whitelists the following IP addresses:

	Securi    = 162.216.19.183
	WP Rocket = 167.114.255.163, 167.114.238.112, 167.114.236.135, 167.114.234.234

And then it also adds the IP address of your server and local machine (ISP).
...
This plugin automatically blocks bad bots. When bad bots fall into the trap, their IP address, user agent, and other information is stored in the WP database. No other user data is collected by this plugin. At any time, you may delete all saved data by visiting the plugin settings. So this plugin does _not_ do anything to make your site _less_ compliant with GDPR. I have done my best to ensure that this plugin is 100% GDPR compliant, but I'm not a lawyer so can't guarantee anything. To determine if your site is GDPR compliant, please consult an attorney.
