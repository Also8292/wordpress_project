...
if (!class_exists('Blackhole_Bad_Bots')) {
	...
	final class Blackhole_Bad_Bots {
		...
		private function constants() {
			...
			if (!defined('BBB_VERSION')) define('BBB_VERSION', '2.1');
		...
		public static function default_uas() {
			...
			$uas  = 'adsbot-google, aolbuild, apis-google, baidu, bingbot, bingpreview, butterfly, cloudflare, duckduckgo, embedly, ';
			$uas .= 'facebookexternalhit, facebot, googlebot, ia_archiver, linkedinbot, mediapartners-google, msnbot, netcraftsurvey, ';
			$uas .= 'outbrain, pinterest, quora, rogerbot, showyoubot, slackbot, slurp, sogou, teoma, tweetmemebot, twitterbot, ';
			$uas .= 'urlresolver, vkshare, w3c_validator, wordpress, wprocketbot, yandex';
